...
- Plans with no missing or short context flags: 2 (`14 Days on Anxiety and Trust`, `Grief and Comfort`)
- Plans still pending context review or expansion: 46
- Exact day-level context review rows: 1,133
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 21 Days in John | 21 | 0 | 21 | 21 | 0 | 0 |
